...
def bounding_box(obj: pg.sprite.Sprite):
    ...
    top_left_y = obj.y - ((obj.height / 2) * math.sin(-math.radians(obj.rotation)))

    bot_left_x = top_left_x
    bot_left_y = top_left_x - obj.height

    top_right_x = top_left_x + obj.width
    top_right_y = top_left_y

    bot_right_x = bot_left_x + obj.width
